...
for dataset in $DATASETS; do
  case "$dataset" in
    msrvtt)
      ...
      candidate_file="candidates/msrvtt_c${code_num}l${code_length}_${num_candidates}_candidates_t2.json"
    ...
    actnet)
      ...
      candidate_file="candidates/actnet_c${code_num}l${code_length}_${num_candidates}_candidates_t2.json"
    ...
    didemo)
      ...
      candidate_file="candidates/didemo_c${code_num}l${code_length}_${num_candidates}_candidates_t2.json"
    ...
    lsmdc)
      ...
      candidate_file="candidates/lsmdc_c${code_num}l${code_length}_${num_candidates}_candidates_t2.json"
