...
CANDIDATE_FILE=${CANDIDATE_FILE:-candidates/GRDR/didemo/didemo_t1_100_candidates.json}
RESULT_FILE=${RESULT_FILE:-reproduction/GRDR/didemo/inductive/result.csv}
