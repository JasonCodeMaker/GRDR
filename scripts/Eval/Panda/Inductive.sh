...
VIDEOS_DIR=${VIDEOS_DIR:-data/panda}
XPOOL_CACHE_ROOT=${XPOOL_CACHE_ROOT:-reranker/xpool/video_features_cache/Xpool-Panda}
CANDIDATE_FILE=${CANDIDATE_FILE:-candidates/GRDR/panda/panda_t1_200_candidates.json}
RESULT_FILE=${RESULT_FILE:-reproduction/GRDR/panda/inductive/result.csv}
