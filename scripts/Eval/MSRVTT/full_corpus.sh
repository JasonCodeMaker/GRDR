...
GRDR_CKPT=${GRDR_CKPT:-output/checkpoints/GRDR/msrvtt/best_model/best_model.pt}
XPOOL_CKPT=${XPOOL_CKPT:-reranker/xpool/ckpt/msrvtt9k_model_best.pth}
VIDEOS_DIR=${VIDEOS_DIR:-dataset/msrvtt_data/MSRVTT_Videos}
XPOOL_CACHE_ROOT=${XPOOL_CACHE_ROOT:-reranker/xpool/video_features_cache/Xpool}
CANDIDATE_FILE=${CANDIDATE_FILE:-candidates/GRDR/msrvtt/msrvtt_t2_100_candidates.json}
RESULT_FILE=${RESULT_FILE:-reproduction/GRDR/msrvtt/full_corpus/result.csv}
