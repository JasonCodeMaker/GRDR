...
CANDIDATE_FILE=${CANDIDATE_FILE:-candidates/GRDR/msrvtt/msrvtt_t1_100_candidates.json}
RESULT_FILE=${RESULT_FILE:-reproduction/GRDR/msrvtt/inductive/result.csv}
