...
GRDR_CKPT=${GRDR_CKPT:-output/checkpoints/GRDR/actnet/best_model/best_model.pt}
XPOOL_CKPT=${XPOOL_CKPT:-reranker/xpool/ckpt/actnet_model_best.pth}
VIDEOS_DIR=${VIDEOS_DIR:-dataset/ActivityNet/Activity_Videos}
XPOOL_CACHE_ROOT=${XPOOL_CACHE_ROOT:-reranker/xpool/video_features_cache/Xpool}
CANDIDATE_FILE=${CANDIDATE_FILE:-candidates/GRDR/actnet/actnet_t2_100_candidates.json}
RESULT_FILE=${RESULT_FILE:-reproduction/GRDR/actnet/full_corpus/result.csv}
