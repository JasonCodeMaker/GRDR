...
CANDIDATE_FILE=${CANDIDATE_FILE:-candidates/GRDR/actnet/actnet_t1_100_candidates.json}
RESULT_FILE=${RESULT_FILE:-reproduction/GRDR/actnet/inductive/result.csv}
