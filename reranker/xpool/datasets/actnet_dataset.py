...
class ActivityNetDataset(Dataset):
    ...
    Annotation format: [{video: "v_xxx.mp4", caption: ["cap1", "cap2", ...]}]
    Video path: {videos_dir}/{video_id} (video_id includes .mp4 suffix)
    """
    ...
    def __init__(self, config: Config, split_type='train', img_transforms=None):
        ...
        if split_type == 'train':
            ...
            anno_file = 'reranker/xpool/data/ACTNET/actnet_ret_test.json'
    ...
    def _generate_candidate_mask(self, candidate_file, extra_vid_ids=None):
        ...
        # Note: ACTNET stores IDs with .mp4 suffix internally, normalize to match candidate JSON
